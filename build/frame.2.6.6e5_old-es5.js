  ...
  Smooch.on('message', function (message) {
    ...
    if (message.role == 'appMaker') {
      ...
      if (GetStorageData('zyxmesurvey') && ((_message$metadata10 = message.metadata) === null || _message$metadata10 === void 0 ? void 0 : _message$metadata10.pendingsurvey) == false) {
        var _smoochDOM$querySelec15;

        // Si estuvo en encuesta y ya acabo la encuesta, cerrar el chat
        (_smoochDOM$querySelec15 = smoochDOM.querySelector('textarea')) === null || _smoochDOM$querySelec15 === void 0 ? void 0 : _smoochDOM$querySelec15.setAttribute('disabled', 'true');
        setTimeout(function () {
          SmoochRefresh();
        }, 3000);
      }
...
function SmoochMessageReceived() {
  Smooch.on('message:received', function (message, data) {
    var _smoochDOM$querySelec16, _smoochDOM$querySelec17;

    var smoochDOM = window.frames['web-messenger-container'].contentDocument;
    (_smoochDOM$querySelec16 = smoochDOM.querySelector('#conversation')) === null || _smoochDOM$querySelec16 === void 0 ? void 0 : _smoochDOM$querySelec16.scrollTo(0, (_smoochDOM$querySelec17 = smoochDOM.querySelector('#conversation')) === null || _smoochDOM$querySelec17 === void 0 ? void 0 : _smoochDOM$querySelec17.scrollHeight);
  });
...
function toggleUserModal() {
  ...
  if (contactmodal.style.display == 'block') {
    var _smoochDOM$querySelec18, _smoochDOM$querySelec19;

    (_smoochDOM$querySelec18 = smoochDOM.querySelector('#messenger-button')) === null || _smoochDOM$querySelec18 === void 0 ? void 0 : (_smoochDOM$querySelec19 = _smoochDOM$querySelec18.querySelector('img')) === null || _smoochDOM$querySelec19 === void 0 ? void 0 : _smoochDOM$querySelec19.setAttribute('src', zyxmeconfig.stringButtonIconUrl);
    ...
    var _smoochDOM$querySelec20, _smoochDOM$querySelec21;

    var buttonURL = zyxmeconfig.stringCancelIconUrl != '' ? zyxmeconfig.stringCancelIconUrl : zyxmeconfig.stringButtonIconUrl;
    (_smoochDOM$querySelec20 = smoochDOM.querySelector('#messenger-button')) === null || _smoochDOM$querySelec20 === void 0 ? void 0 : (_smoochDOM$querySelec21 = _smoochDOM$querySelec20.querySelector('img')) === null || _smoochDOM$querySelec21 === void 0 ? void 0 : _smoochDOM$querySelec21.setAttribute('src', buttonURL);
...
window.onclick = function (event) {
  ...
  if (smoochDOM != null) {
    ...
    if (zyxmeconfig.formCloseClickout && event.target == contactmodal) {
      var _smoochDOM$querySelec22;

      var _smoochDOM = window.frames['web-messenger-container'].contentDocument;
      (_smoochDOM$querySelec22 = _smoochDOM.querySelector('#messenger-button').querySelector('img')) === null || _smoochDOM$querySelec22 === void 0 ? void 0 : _smoochDOM$querySelec22.setAttribute('src', zyxmeconfig.stringButtonIconUrl);
...
function sendHookRequest(data) {
  fetch(zyxmeconfig.webhookUrl, {
    ...
    if ((usegroups || useclassifications) && usequeue) {
      ...
      setTimeout(function () {
        fetch(zyxmeconfig.webchatscriptUrl + '/conversation/' + zyxmeconfig.smoochAppId + '/' + smoochAppUserId).then(function (res1) {
          res1.json().then(function (res2) {
            ...
            var smoochDOM = window.frames['web-messenger-container'].contentDocument;
            (_smoochDOM$querySelec23 = smoochDOM.querySelector('#messenger-button').querySelector('img')) === null || _smoochDOM$querySelec23 === void 0 ? void 0 : _smoochDOM$querySelec23.setAttribute('src', zyxmeconfig.stringButtonIconUrl);
            var contactmodal = document.querySelector('#contactModal');
      ...
      var _smoochDOM$querySelec24;

      var smoochDOM = window.frames['web-messenger-container'].contentDocument;
      (_smoochDOM$querySelec24 = smoochDOM.querySelector('#messenger-button').querySelector('img')) === null || _smoochDOM$querySelec24 === void 0 ? void 0 : _smoochDOM$querySelec24.setAttribute('src', zyxmeconfig.stringButtonIconUrl);
      var contactmodal = document.querySelector('#contactModal');
...
function _closeUserModal() {
  _closeUserModal = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var smoochDOM, contactmodal, speechbubble, _smoochDOM$querySelec25, _smoochDOM$querySelec26;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (_smoochDOM$querySelec25 = smoochDOM.querySelector('#messenger-button')) === null || _smoochDOM$querySelec25 === void 0 ? void 0 : (_smoochDOM$querySelec26 = _smoochDOM$querySelec25.querySelector('img')) === null || _smoochDOM$querySelec26 === void 0 ? void 0 : _smoochDOM$querySelec26.setAttribute('src', zyxmeconfig.stringButtonIconUrl);
...
function _openUserModal() {
  _openUserModal = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var smoochDOM, contactmodal, speechbubble, _smoochDOM$querySelec27, buttonURL;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            (_smoochDOM$querySelec27 = smoochDOM.querySelector('#messenger-button').querySelector('img')) === null || _smoochDOM$querySelec27 === void 0 ? void 0 : _smoochDOM$querySelec27.setAttribute('src', buttonURL);
